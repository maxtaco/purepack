...
(function() {
  var CharMap, MyBuffer, NodeBuffer, encode_byte, encode_chunk, first_non_ascii, pow2, rshift, twos_compl_inv, _ref;
  ...
  exports.Buffer = MyBuffer = (function() {

    MyBuffer.prototype.B16 = new CharMap("0123456789abcdef");

    MyBuffer.prototype.B32 = new CharMap("abcdefghijkmnpqrstuvwxyz23456789");

    MyBuffer.prototype.B64 = new CharMap("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", "=");

    MyBuffer.prototype.B64X = new CharMap("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789@_", "=");

    MyBuffer.prototype.B64A = new CharMap("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+-", "=");
    ...
    MyBuffer.prototype.get_errors = function() {
      if (this._e.length) {
        return this._e;
      } else {
        return null;
    ...
    MyBuffer.prototype._push_new_buffer = function() {
      var nb;
    ...
    MyBuffer.prototype._left_in_buffer = function() {
      return this._sz - this._i;
    };

    MyBuffer.prototype.push_byte = function(b) {
      var buf;
    ...
    MyBuffer.prototype.push_short = function(i) {
      this.push_byte((i >> 8) & 0xff);
      return this.push_byte(i & 0xff);
    };

    MyBuffer.prototype.push_int = function(i) {
      this.push_byte((i >> 24) & 0xff);
      this.push_byte((i >> 16) & 0xff);
      this.push_byte((i >> 8) & 0xff);
      return this.push_byte(i & 0xff);
    };

    MyBuffer.prototype.push_raw_bytes = function(s) {
      var a, i, _i, _ref1;
    ...
    MyBuffer.prototype.push_buffer = function(input) {
    ...
    MyBuffer.prototype.push_utf8_codepoint = function(c) {
      if (c >= 0x10000) {
    ...
    MyBuffer.prototype.push_utf8_string = function(s) {
      var cc, i, _i, _ref1;
      for (i = _i = 0, _ref1 = s.length; 0 <= _ref1 ? _i < _ref1 : _i > _ref1; i = 0 <= _ref1 ? ++_i : --_i) {
        cc = s.charCodeAt(i);
    ...
    MyBuffer.prototype.toString = function(enc) {
    ...
    MyBuffer.prototype.encode = function(e) {
      return this.toString(e);
    };

    MyBuffer.prototype.bytes_left = function() {
      return this._tot - this._cp;
    };

    MyBuffer.prototype._get = function(i, n) {
    ...
    MyBuffer.prototype.ui8a_encode = function() {
      var hold, raw;
      hold = this._cp;
      this._cp = 0;
    ...
    MyBuffer.prototype.binary_encode = function() {
      var i, v;
      v = (function() {
    ...
    MyBuffer.prototype.base16_encode = function() {
    ...
    MyBuffer.prototype.base32_encode = function() {
    ...
    MyBuffer.prototype.base64_encode = function() {
      return this._base64_encode(this.B64);
    };

    MyBuffer.prototype.base64a_encode = function() {
      return this._base64_encode(this.B64A);
    };

    MyBuffer.prototype.base64x_encode = function() {
      return this._base64_encode(this.B64X);
    };

    MyBuffer.prototype._base64_encode = function(M) {
    ...
    MyBuffer.decode = function(s, enc) {
      switch (enc) {
        case 'binary':
          return (new MyBuffer).binary_decode(s);
        case 'base64':
          return (new MyBuffer).base64_decode(s);
        case 'base64a':
          return (new MyBuffer).base64a_decode(s);
        case 'base64x':
          return (new MyBuffer).base64x_decode(s);
        case 'base32':
          return (new MyBuffer).base32_decode(s);
        case 'hex':
          return (new MyBuffer).base16_decode(s);
        case 'ui8a':
          return (new MyBuffer).ui8a_decode(s);
      }
    };

    MyBuffer.prototype.ui8a_decode = function(v) {
      this._buffers = [v];
      this._logsz = 0;
    ...
    MyBuffer.prototype.binary_decode = function(b) {
      var i, _i, _ref1;
    ...
    MyBuffer.prototype.base16_decode = function(data) {
    ...
    MyBuffer.prototype._base64_decode = function(data, M) {
    ...
    MyBuffer.prototype.base64_decode = function(data) {
      return this._base64_decode(data, this.B64);
    };

    MyBuffer.prototype.base64a_decode = function(data) {
      return this._base64_decode(data, this.B64A);
    };

    MyBuffer.prototype.base64x_decode = function(data) {
      return this._base64_decode(data, this.B64X);
    };

    MyBuffer.prototype.base32_decode = function(data) {
    ...
    MyBuffer.prototype.read_bytes = function(n) {
      var i, _i, _results;
      _results = [];
    ...
    MyBuffer.prototype.read_uint8 = function() {
      return this._get(this._cp++);
    };

    MyBuffer.prototype.read_uint16 = function() {
      return (this.read_uint8() << 8) | this.read_uint8();
    };

    MyBuffer.prototype.read_uint32 = function() {
      return (this.read_uint8() << 24) | (this.read_uint8() << 16) | (this.read_uint8() << 8) | this.read_uint8();
    };

    MyBuffer.prototype.read_int8 = function() {
      return twos_compl_inv(this.read_uint8(), 8);
    };

    MyBuffer.prototype.read_int16 = function() {
      return twos_compl_inv(this.read_uint16(), 16);
    };

    MyBuffer.prototype.read_int32 = function() {
      return twos_compl_inv(this.read_uint32(), 32);
    };

    MyBuffer.prototype.read_double = function() {
      return this._read_float(8);
    };

    MyBuffer.prototype.read_float = function() {
      return this._read_float(4);
    };

    MyBuffer.prototype._read_float = function(nb) {
      var a, dv;
      a = this.read_byte_array(nb);
      dv = new DataView(a);
      return dv["getFloat" + (nb << 3)].call(dv, 0, false);
    };

    MyBuffer.prototype.read_chunk = function(n) {
      var ret;
    ...
    MyBuffer.prototype.read_byte_array = function(n) {
      var chnk, i, ret;
      i = 0;
    ...
    MyBuffer.prototype.prep_byte_grab = function(n) {
      var bl;
      bl = this.bytes_left();
      if (n > bl) {
    ...
    MyBuffer.prototype.read_utf8_string = function(n) {
    ...
    MyBuffer.utf8_to_ui8a = function(s) {
      var c, i, n, ret, rp;
    ...
    MyBuffer.ui8a_to_binary = function(b) {
