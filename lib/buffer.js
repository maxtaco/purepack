...
(function() {
  var CharMap, MyBuffer, NodeBuffer, encode_byte, encode_chunk, first_non_ascii, pow2, rshift, _ref;
  ...
  exports.Buffer = MyBuffer = (function() {
    ...
    MyBuffer.prototype.consume_byte = function() {
      return this._get(this._cp++);
    };

    MyBuffer.prototype.consume_bytes = function(n) {
      var i, _i, _results;
      _results = [];
    ...
    MyBuffer.prototype.consume_chunk = function(n) {
      var ret;
    ...
    MyBuffer.prototype.consume_byte_array = function(n) {
      var chnk, i, ret;
      i = 0;
    ...
    MyBuffer.prototype.consume_utf8_string = function(n) {
  ...
  exports.utf8_to_ui8a = function(s) {
    var c, i, n, ret, rp;
    return new Uint8Array(new NodeBuffer(s, 'utf8'));
