...
(function() {
  ...
  exports.Buffer = Buffer = (function() {
    ...
    Buffer.prototype._get = function(i, n) {
      var bi, li, lim, ret;
      if (n == null) n = null;
      ret = i >= this._tot ? 0 : (bi = this._logsz ? i >>> this._logsz : 0, li = i % this._sz, lim = bi === this._b ? this._i : this._sz, ret = bi > this._b || li >= lim ? n != null ? [] : 0 : n == null ? this._buffers[bi][li] : (n = Math.min(lim - li, n), this._buffers[bi].slice(li, li + n)));
      return ret;
    };
