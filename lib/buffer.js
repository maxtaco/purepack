  ...
  exports.Buffer = Buffer = (function() {
    ...
    Buffer.prototype.push_buffer = function(input) {
      ...
      while (bp < ep) {
        ...
        slab.set(input.subarray(bp, n), this._i);
        this._i += n;
        this._tot += n;
        bp += n;
      }
      if (this._i === this._sz) this._push_new_buffer();
      return this;
    };
    ...
    Buffer.prototype.ui8a_encode = function() {
      var hold, raw, w, _ref1;
      hold = this._cp;
      this._cp = 0;
      _ref1 = this.consume_byte_array(this._tot), w = _ref1[0], raw = _ref1[1];
      this._cp = hold;
      return raw;
    };
    ...
    Buffer.prototype.consume_byte_array = function(n) {
      var chnk, i, ret, w, _ref1;
      i = 0;
      _ref1 = this.prep_byte_grab(n), w = _ref1[0], n = _ref1[1];
    ...
    Buffer.prototype.consume_utf8_string = function(n) {
      var chnk, chnksz, i, ret, s, tmp, w, _ref1;
