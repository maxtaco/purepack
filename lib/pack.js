...
(function() {
  var Buffer, C, Packer, U32MAX, floats, is_array, is_int, pow2, rshift, twos_compl, u64max_minus_i, utf8_to_ui8a, _ref, _ref1;

  C = require('./const').C;

  _ref = require('./buffer'), Buffer = _ref.Buffer, utf8_to_ui8a = _ref.utf8_to_ui8a;
  ...
  exports.Packer = Packer = (function() {
    ...
    Packer.prototype.do_byte_array = function(o) {
      return this._opts.byte_arrays && Object.prototype.toString.call(o) === '[object Uint8Array]';
    };
