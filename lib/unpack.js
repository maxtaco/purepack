...
(function() {
  ...
  C = require('./const.coffee').C;

  PpBuffer = require('./buffer.coffee').PpBuffer;

  _ref = require('./util.coffee'), pow2 = _ref.pow2, twos_compl_inv = _ref.twos_compl_inv, U32MAX = _ref.U32MAX;
