...
(function() {
  var NodeBuffer, base, twos_compl_inv,
  ...
  exports.Buffer = NodeBuffer = (function(_super) {
    ...
    function NodeBuffer() {
      ...
      this._limits = [];
      this._sz = 0x1000;
      this._small_buf_sz = 0x200;
      this._logsz = 12;
      this._i = 0;
    }

    NodeBuffer.decode = function(s, enc) {
      return base.Buffer._decode(NodeBuffer, s, enc);
    };
    ...
    NodeBuffer.prototype._push_sub_buffer = function(b) {
      if (this._sub_buffers.length) this._finish_sub_buffer();
      this._lib = function() {
    ...
    NodeBuffer.prototype._make_room = function() {
      return this._push_sub_buffer(new Buffer(this._sz));
    };

    NodeBuffer.prototype._make_room_for_n_bytes = function(n) {
      if (this._lib() < n) return this._make_room();
    };
    ...
    NodeBuffer.prototype.push_buffer = function(b) {
      var diff, n;
      if (b.length > Math.min(this._small_buf_sz, this._sz)) {
    ...
    NodeBuffer.prototype.base64_decode = function(d) {
      return this._freeze_to(new Buffer(d, 'base64'));
    };

    NodeBuffer.prototype.base16_decode = function(d) {
      return this._freeze_to(new Buffer(d, 'hex'));
    };

    NodeBuffer.prototype.binary_decode = function(d) {
      return this._freeze_to(new Buffer(d, 'binary'));
    };

    NodeBuffer.prototype.ui8a_decode = function(d) {
      return this._freeze_to(new Buffer(d));
    };
    ...
    NodeBuffer.type = function() {
      return base.Buffer.types.prototype.NODE;
    };
