...
(function() {
  ...
  exports.Converter = Converter = (function() {
    ...
    Converter.prototype.read_float32 = function() {
      return this._read_float(4);
    };

    Converter.prototype.read_float64 = function() {
  ...
  exports.Browser = Browser = (function(_super) {
    ...
    Browser.prototype._read_float = function(n) {
      var ab, b, dv, i, ia, _i, _len, _ref;
      ab = new ArrayBuffer(n);
      ia = new Uint8Array(ab);
      dv = new DataView(ab);
      _ref = this._buffer.read_bytes(n);
  ...
  exports.Node = Node = (function(_super) {
    ...
    Node.prototype._read_float = function(n) {
      var b, f;
      b = new Buffer(this._buffer.read_bytes(n));
