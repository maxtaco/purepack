...
(function() {
  var BrowserBuffer, base, encode_byte, first_non_ascii, pow2, rshift, twos_compl, twos_compl_inv, ui8a_to_array_buffer, uri_encode_chunk, _ref,
  ...
  ui8a_to_array_buffer = function(b) {
    var c, i, ret, _i, _len;
  ...
  exports.PpBuffer = BrowserBuffer = (function(_super) {
    ...
    BrowserBuffer.prototype.push_float32 = function(val) {
      ...
      return this.push_buffer(new Uint8Array(tmp));
    };
