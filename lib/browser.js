...
(function() {
  var BrowserBuffer, ab_to_ui8a, base, encode_byte, first_non_ascii, pow2, rshift, twos_compl, twos_compl_inv, ui8a_to_ab, uri_encode_chunk, _ref,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };



  _ref = require('./util.coffee'), pow2 = _ref.pow2, rshift = _ref.rshift, twos_compl_inv = _ref.twos_compl_inv, twos_compl = _ref.twos_compl;

  base = require('./base.coffee');

  ui8a_to_ab = function(b) {
    var c, i, ret, _i, _len;
