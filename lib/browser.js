...
(function() {
  var BaseBuffer, BrowserBuffer, encode_byte, first_non_ascii, pow2, rshift, twos_compl, twos_compl_inv, uri_encode_chunk, _ref,
  ...
  exports.Buffer = BrowserBuffer = (function(_super) {
    ...
    BrowserBuffer.decode = function(s, enc) {
      return BaseBuffer._decode(BrowserBuffer, s, enc);
    };
    ...
    BrowserBuffer.prototype.bytes_left = function() {
